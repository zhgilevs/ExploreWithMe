...
- Администратор может создавать, редактировать и удалять категории, к которым будут относиться созданные пользователями мероприятия;
...
- Пользователь должен понимать, что он не сможет отредактировать свой комментарий или удалить его, если на его комментарий ответил другой пользователь;
- Также теперь при запросе информации о мероприятиях отображаются комментарии по этим мероприятиям;
