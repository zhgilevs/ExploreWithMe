...
(
    ...
    comment_created_on timestamp(0) without time zone not null,
    comment_last_updated_on timestamp(0) without time zone,
    comment_author_id bigint not null,
    comment_event_id bigint not null,
    comment_reply_to_comment_id bigint,
    ...
    constraint comments_fk_event_id foreign key (comment_event_id) references events(event_id) on delete cascade,
    constraint comments_fk_comment_id foreign key (comment_reply_to_comment_id) references comments(comment_id)
);